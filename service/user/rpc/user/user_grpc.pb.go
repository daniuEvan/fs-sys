...
func (c *userClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*UserInfoResponse, error) {
...
func (UnimplementedUserServer) Login(context.Context, *LoginRequest) (*UserInfoResponse, error) {
